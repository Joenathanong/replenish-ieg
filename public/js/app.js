...
async function render() {
  ...
  try {
    ...
    } else if (state.tab === 'adjustment') {
      // Didefinisikan di adjustment-tab.js, dimuat sebelum berkas ini.
...
const TABS = ['monitoring', 'pengaturan', 'ambang', 'transaksi', 'adjustment', 'riwayat'];
